...
var makeTriggerRegex = function(trigger) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function(isTextarea) {
      ...
      if (_this.selectFocusedCalled) _this.selectFocusedCalled = !1; else if (_this.setState({
      ...
      _this.selectFocusedCalled = !0, _this.addMention(result, queryInfo), _this.setState({
        focusIndex: 0
      });
    ...
    _this.handlePaste = _this.handlePaste.bind(_assertThisInitialized(_this)), _this.selectFocusedCalled = !1, 
    _this.state = {
      focusIndex: 0,
      selectionStart: null,
      selectionEnd: null,
